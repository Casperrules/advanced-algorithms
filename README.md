...
| ----------------------------- | ------- | ----------------------- |
| Miller-Rabin (10 rounds, 10⁹) | 2.17 µs | ~460K primality tests/s |
| Extended Euclidean (10⁹)      | 4.10 ns | ~244M gcd/s             |
...
| Floyd-Warshall | 1.01 µs | ~990K ops/s |

### Monte Carlo Integration

| Algorithm                   | Time     | Samples/s      |
| --------------------------- | -------- | -------------- |
| Pi Estimation (10K samples) | 171.6 µs | ~58M samples/s |
